...
import org.progchen.SurveyZone.util.StringUtil;
...
public class Question {
	...
	public void setOptions(String options) {
		...
		this.optionArr = StringUtil.splitOptions(options, NEXT);
	}
	...
	public void setOtherSelectOptions(String otherSelectOptions) {
		...
		this.otherSelectOptionArr = StringUtil.splitOptions(otherSelectOptions,NEXT);
	}
	...
	public void setMatrixRowTitles(String matrixRowTitles) {
		...
		this.matrixRowTitleArr = StringUtil.splitOptions(matrixRowTitles, NEXT);
	}
	...
	public void setMatrixColTitles(String matrixColTitles) {
		...
		this.matrixColTitleArr = StringUtil.splitOptions(matrixColTitles, NEXT);
	}
	...
	public void setMatrixSelectOptions(String matrixSelectOptions) {
		...
		this.matrixSelectOptionArr = StringUtil.splitOptions(matrixSelectOptions, NEXT);
	}
